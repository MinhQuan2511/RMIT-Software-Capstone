          ...
          return (
            <li key={step.path}>
              {isAllowed ? (
                ...
                <div
                  className="flex items-center justify-between px-4 py-3 rounded-xl font-semibold cursor-not-allowed opacity-40 select-none text-on-surface-variant"
                  title="Complete preceding steps to unlock"
                >
